  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | City Barbershop</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop City Barbershop in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="City Barbershop | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="City Barbershop | Premium Barbershop Berlin" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "sameAs": [
              "https://www.facebook.com/citybarbershop",
              "https://www.instagram.com/citybarbershop"
            ]
          })}
        </script>
      </Helmet>
